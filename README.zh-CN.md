...
<p align="center">
  <img src="https://skillicons.dev/icons?i=ts,js,react,nextjs,vue,nestjs,nodejs,electron,docker,go,vite,git,github&perline=13&theme=dark" alt="TypeScript、JavaScript、React、Next.js、Vue、NestJS、Node.js、Electron、Docker、Go、Vite、Git 和 GitHub" />
</p>
